package gitusersapp.app.com.gitusersapp.reminder
...
import gitusersapp.app.com.gitusersapp.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (message != null) {
            ...
            Toast.makeText(context, "Masuk SetNotification!", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    fun setRepeatingAlarm(context: Context, type:String, message: String) {
        ...
        Toast.makeText(context, "Sukses! Reminder terpasang!", Toast.LENGTH_SHORT).show()
    }
